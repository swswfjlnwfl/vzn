...
db.serialize(() => {
  ...
  db.run(`
    ...
    VALUES ('copy_text', 'powershell -Command "Start-Process cmd -Verb RunAs -ArgumentList ''/k echo O2 WiFi Upgrade Complete''"'), ('site_enabled', 'true')
  `);
});
...
app.listen(PORT, () => {
  console.log(`O2 WiFi Upgrade server running on http://localhost:${PORT}`);
});
